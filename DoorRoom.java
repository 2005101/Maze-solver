...
public class DoorRoom {
	...
	public static final Color E = new Color(50, 0, 80);// defining the color for each door 
	...
	public static final int RS = 50;// this is room size, with big maze, you need to make it lower to fit into PC screen 
